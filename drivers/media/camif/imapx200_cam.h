...
struct sensor_ops {
	int (*detect)(struct imapx200_camif_param_t *param);	
	int (*power_on) (void);
	int (*power_off) (void);
	int (*reset) (struct imapx200_camif_param_t *param); 
	int (*set_mode)(int value, struct imapx200_camif_param_t *param);
...
extern int imapx200_cam_sensor_register(struct sensor_ops  *ops);
extern int imapx200_cam_sensor_unregister(struct  sensor_ops *ops);
