...
/* configurations */
#define IMAPFB_HFP		212		/* front porch */
#define IMAPFB_HSW		58		/* hsync width */
#define IMAPFB_HBP		50		/* back porch */
#define IMAPFB_VFP		11		/* front porch */
#define IMAPFB_VSW		1		/* vsync width */
#define IMAPFB_VBP		26		/* back porch */
...
#define IMAPFB_IDS_CFG	0x1212	/* this value will be put in DIV_CFG4 */
#define IMAPFB_CLK_DIV	1	/* this value will be put in DIV_CFG4 */
