...
#else
#define	READ_BATT0(vref)   0xE5	
#define	READ_BATT1(vref)   0xE5	
#define	READ_BATT2(vref)   0xE5	
#define	READ_BATT3(vref)   0xE5	
#define	READ_BATT4(vref)   0xE5
#endif
...
//	printk(KERN_EMERG"~~~~~~~~~~~~~~~~~~ power:%d, power:%d ,power:%d, power:%d, power:%d~~~~~~~~~~~~~~~~~~~~~~\n", z2, read_batt0, read_batt1, read_batt2, read_batt3);
