...
#define rGPRDAT    			 (IMAP_VA_GPIO+0x110 )     //Port A Data Register
#define rGPRCON   			 (IMAP_VA_GPIO+0x114 )     //Port A Data Direction Register
#define rGPRPUD     		 	 (IMAP_VA_GPIO+0x118 )     //Port A Data Source
