...
static struct rt5621_reg init_data[] = {
	...
	{RT5621_STEREO_DAC_VOL,         0x6808},    //default stereo DAC volume to 0db
	{RT5621_OUTPUT_MIXER_CTRL,      0xd300},    //default output mixer control
	{RT5621_ADC_REC_GAIN,		0xff9f},    //set record to 30db gain
	{RT5621_MIC_CTRL,               0x0000},    //set Mic1 boost 0db
...
// shaft 0225		rt5621_AudioOutEnable(codec,RT_WAVOUT_SPK,0);	//unmute speaker out
...
// shaft 0225		rt5621_AudioOutEnable(codec,RT_WAVOUT_SPK,1);	//mute speaker out
